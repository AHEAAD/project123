...
function FAQs() {  
  ...
  return (  
    <div className="faq-container px-[115px] pt-20 border-b border-white bg-nurse-300">  
      <h1 className="text-white font-bold text-4xl mb-4">Frequently Asked Questions</h1>  
