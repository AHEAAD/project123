...
export const updateabt = [
  {pic: "/public/pictures/webinar.png",
    head: "WEBINAR",
    desc: "Virtual Consultations 101: What to Expect",
    down: "Learn More"
  },
  {pic: "/public/pictures/news.png",
    head: "NEWS",
    desc: "Telemedicine Usage Surges Globally",
    down: "Learn More"
  },
  {pic: "/public/pictures/blog.png",
    head: "BLOG",
...
export const OneDashHome = [
  {
    ...
    img : "/public/pictures/FlowerDash.png"
  }
];
...
export const abtdat = [
  {
    ...
    header: "We simplify healthcare through technology, connecting patients with doctors remotely.",
    link: [
      { subhead: "Comprehensive Care", desc: "From monitoring vitals to managing records, our platform provides a complete healthcare solution" },
      {
        subhead: "Real-Time Consultations",
        desc: "Talk to doctors in real-time, share data, and receive care without leaving home",
      },
      { subhead: "Secure and Accessible", desc: "Your health information is safe and always available, no matter where you are" },
